...
import useInvestors from "../../hooks/projects/useInvestors";
...
const columns = [
    ...
    {
        Header: "Invested Module Details",
        accessor: "moduleData"
    },
    {
        Header: "Invested NFT",
...
export default function ProjectsTable(props: ProjectsTableProps) {
    ...
    const query = useInvestors({ filters });
                    ...
                    <Tr key={project.handle}>
                        {
                            columns.map((column, ix) => {
                                if (column.Header === "Actions") {
                                    return <Td key={ix}>
                                        <GalleryActionButton href={`/projects/${project.profileId}/${project.projectId}`} icon={<ViewIcon />} colorScheme="blue">View</GalleryActionButton>
                                    </Td>;
                                }
                                ...
                                //     </Td>
                                // } 
                                else if (column.Header === "Invested at") {
                                    return (
                                        <Td key={ix}>
